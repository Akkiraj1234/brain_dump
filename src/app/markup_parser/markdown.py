"""
0. lets say i have the markdown fille which will transefer markdown syntax into my code form and then that will parse into my custom parser that will print the text

which will create my custom parsser whom i can work with okay 
